...
const features = [
  {
    ...
    description: "Upload any document, paper, or content. PDFs, articles, research, datasets - our system processes everything instantly.",
    visual: "deploy",
  },
  {
    number: "02",
    title: "AI-Powered Search",
    description: "Find exactly what you need using semantic search. Our AI understands meaning, context, and connections beyond keywords.",
    visual: "ai",
  },
  {
    number: "03",
    title: "Smart Organization",
    description: "Automatic categorization and tagging. Your knowledge base organizes itself, learning from your patterns.",
    visual: "collab",
  },
  {
    number: "04",
    title: "Collaborative Insights",
    description: "Share findings, annotate materials, and work together. Build collective intelligence with your team.",
    visual: "security",
  },
];
