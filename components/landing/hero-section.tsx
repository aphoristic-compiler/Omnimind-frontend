...
import { AnimatedBrain } from "./animated-brain";

const words = ["organize", "discover", "analyze", "collaborate"];
    ...
    <section className="relative min-h-screen flex flex-col justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12 py-24 lg:py-32">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-end">
          <p 
            className={`text-lg lg:text-xl text-muted-foreground leading-relaxed max-w-2xl mb-8 transition-all duration-700 delay-200 ${
              isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
            }`}
          >
            Upload materials, get instant AI-powered insights, and collaborate smarter.
          </p>
      ...
      <div 
        className={`absolute bottom-0 left-0 right-0 pb-12 transition-all duration-700 delay-500 ${
        ...
        <div className="flex gap-16 marquee whitespace-nowrap">
          {[...Array(2)].map((_, i) => (
            <div key={i} className="flex gap-16">
              {[
                { value: "10M+", label: "documents indexed", company: "MONTHLY" },
                { value: "99.9%", label: "search accuracy", company: "SEMANTIC AI" },
                { value: "2s", label: "average query time", company: "RESPONSE" },
                { value: "100K+", label: "active researchers", company: "GLOBAL" },
              ].map((stat) => (
